    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 space-y-8">
          ...
          {/* 3. Price Quotes */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Price Quotes</h2>
            <p className="text-gray-700 leading-relaxed mb-2">
          ...
          {/* 4. Device Conditions */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Device Conditions</h2>
            <p className="text-gray-700 leading-relaxed mb-2">
          ...
          {/* 6. Payment */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Payment</h2>
            <p className="text-gray-700 leading-relaxed mb-2">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              If you have any questions about these Terms and Conditions, please contact us at <a href="mailto:support@recyclemydevice.co.uk" className="text-primary hover:underline">support@recyclemydevice.co.uk</a>
            </p>
          </section>
        </div>
      </div>
