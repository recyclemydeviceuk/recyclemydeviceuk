      ...
      <div className="flex-1 flex flex-col">
          ...
          <div className="px-8 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Additional settings and options</p>
              </div>
              <button
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <ComingSoon
            ...
            description="Access additional features, integrations, reports, and miscellaneous settings."
