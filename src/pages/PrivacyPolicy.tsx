  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2">Privacy Policy</h1>
        ...
        <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
          ...
          {/* Who We Are */}
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Who We Are</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Information We Collect</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-3 sm:mb-4">
              We collect the following types of information:
            </p>

            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Personal Information</h3>
            ...
            <ul className="list-disc list-inside space-y-1.5 sm:space-y-2 text-sm sm:text-base md:text-lg text-gray-700 ml-3 sm:ml-4 mb-4 sm:mb-6">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Device Information</h3>
            <ul className="list-disc list-inside space-y-1.5 sm:space-y-2 text-sm sm:text-base md:text-lg text-gray-700 ml-3 sm:ml-4 mb-4 sm:mb-6">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Technical Information</h3>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">How We Use Your Information</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Sharing Your Information</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-2">
          ...
          {/* Cookies */}
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Cookies</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-2">
          ...
          {/* Data Security */}
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Data Security</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
          ...
          {/* Data Retention */}
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Data Retention</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
          ...
          {/* Your Rights (GDPR) */}
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Your Rights (GDPR)</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-2">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
              To exercise any of these rights, please contact us at <a href="mailto:privacy@recyclemydevice.co.uk" className="text-primary hover:underline break-all">privacy@recyclemydevice.co.uk</a>
            </p>
          </section>

          {/* Third-Party Links */}
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Third-Party Links</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
          ...
          {/* Children's Privacy */}
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Children's Privacy</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Changes to This Policy</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
          ...
          {/* Contact Us */}
          <section>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Contact Us</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-2">
              If you have any questions about this Privacy Policy or how we handle your data, please contact us:
            </p>
            <ul className="space-y-1.5 sm:space-y-2 text-sm sm:text-base md:text-lg text-gray-700 ml-3 sm:ml-4">
