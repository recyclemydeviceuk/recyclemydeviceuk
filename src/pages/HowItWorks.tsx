          ...
          <div className="grid md:grid-cols-2 gap-8">
            {steps.map((step) => {
              ...
              return (
                <div
                  key={step.number}
                  className="bg-white rounded-2xl border border-gray-200 p-8 hover:shadow-xl hover:border-primary/30 transition-all duration-300"
                >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {tips.map((tip, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-all hover:border-primary/20"
                >
